            ...
            <div class="col-lg-9 col-md-12">
                ...
                <div class=" niceselect_option">
                  ...
                  <form class="select_option" action="#">
                    <select name="orderby" id="short">
                      ...
                      <option value="4">Xắp xếp theo giá từ cao đến thấp</option>
                      <option value="5">Xắp xếp theo giá từ thấp đến cao</option>
                      <option value="6">Xắp xếp theo chữ cái(A-Z)</option>
                      <option value="6">Xắp xếp theo chữ cái(Z-A)</option>
                    </select>
                  </form>
              ...
              <div class="row shop_wrapper">
                  ...
                  <div class="single_product">
                    ...
                    <div class="product_content list_content">
                      ...
                      <div class="product_desc">
                        <p>Lorem ipsum dolor sit amet, conzetur adipisicing elit. Nobis ad, iure incidunt. Ab
                          consequatur temporibus non eveniet inventore doloremque necessitatibus sed, ducimus quisquam,
                          ad asperiores eligendi quia fugiat minus doloribus distinctio assumenda pariatur, quidem
                          laborum quae quasi suscipit. Cupiditate dolor blanditiis rerum aliquid temporibus, libero
                          minus nihil, veniam suscipit? Autem repellendus illo, amet praesentium fugit, velit natus?
                          Dolorum perferendis reiciendis in quam porro ratione eveniet, tempora saepe ducimus, alias?
                        </p>
                      </div>
                ...
                <div class="col-lg-4 col-md-4 col-12 ">
                  <div class="single_product">
                    ...
                    <div class="product_content list_content">
                      ...
                      <div class="product_desc">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nobis ad, iure incidunt. Ab
                          consequatur temporibus non eveniet inventore doloremque necessitatibus sed, ducimus quisquam,
                          ad asperiores eligendi quia fugiat minus doloribus distinctio assumenda pariatur, quidem
                          laborum quae quasi suscipit. Cupiditate dolor blanditiis rerum aliquid temporibus, libero
                          minus nihil, veniam suscipit? Autem repellendus illo, amet praesentium fugit, velit natus?
                ...
                <div class="col-lg-4 col-md-4 col-12 ">
                  <div class="single_product">
                    <div class="product_thumb">
                      <a class="primary_img" href="product-details.html"><img src="assets/img/product/product25.jpg"
                          alt=""></a>
                      <a class="secondary_img" href="product-details.html"><img src="assets/img/product/product26.jpg"
                          alt=""></a>
                ...
                <div class="col-lg-4 col-md-4 col-12 ">
                  <div class="single_product">
                    <div class="product_thumb">
                      <a class="primary_img" href="product-details.html"><img src="assets/img/product/product2.jpg"
                          alt=""></a>
                      <a class="secondary_img" href="product-details.html"><img src="assets/img/product/product1.jpg"
                          alt=""></a>
