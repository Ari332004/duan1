...
<div class="slider_area slider_style home_three_slider owl-carousel">
    <div class="single_slider" data-bgimg="assets/img/slider/banner_3.jpg">
        <div class="container">
    ...
    <div class="single_slider" data-bgimg="assets/img/slider/banner_1.jpg">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12">
    ...
    <div class="single_slider" data-bgimg="assets/img/slider/banner_2.jpg">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="banner_area">
                    <div class="banner_thumb">
                        <a href="index.php?act=product"><img src="assets/img/bg/banner_6.jpg" alt="#" /></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
            ...
            <div class=" col-lg-4 col-md-6">
                <div class="banner_area bottom">
                    <div class="banner_thumb">
                        <a href="index.php?act=product"><img src="assets/img/bg/banner_8.jpg" alt="#" /></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="banner_area">
                    <div class="banner_thumb">
                        <a href="index.php?act=product"><img src="assets/img/bg/banner_4.jpg" alt="#" /></a>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="banner_area">
                    <div class="banner_thumb">
                        <a href="index.php?act=product"><img src="assets/img/bg/banner12.png" alt="#" /></a>
                        <div class="banner_content">
                            <h1>
                                Sneaker <br />
                                Men’s Collection
            ...
            <div class="row">
                <div class="product_carousel product_three_column4 owl-carousel">
                    <div class="col-lg-3">
                        <div class="single_product">
                            <div class="product_thumb">
                                <a class="primary_img" href="index.php?act=productdetail"><img
                                        src="assets/img/product/product21.jpg" alt="" /></a>
                                <a class="secondary_img" href="index.php?act=productdetail"><img
                                        src="assets/img/product/product22.jpg" alt="" /></a>
                                <div class="product_action">
                                    <div class="hover_action">
                                        ...
                                        <div class="action_button">
                                            <ul>
                                                <li>
                                                    <a title="add to cart" href="cart.html"><i
                            ...
                            <div class="product_content">
                                <h3>
                                    <a href="index.php?act=productdetail">Marshall Portable Bluetooth</a>
                                </h3>
                                <span class="current_price">£60.00</span>
                                <span class="old_price">£86.00</span>
                            </div>
